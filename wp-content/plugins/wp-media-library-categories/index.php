...
if ( is_admin() ) {
	...
	function wpmediacategory_enqueue_media_action() {
		...
		if ( wp_script_is( 'media-editor', 'enqueued' ) || wp_script_is( 'media-editor', 'registered' ) ) {
			...
			wp_enqueue_script( 'wpmediacategory-media-views', plugins_url( 'js/wpmediacategory-media-views.min.js', __FILE__ ), array( 'media-views' ), '2.1.2', true );
		}
		wp_enqueue_style( 'wpmediacategory', plugins_url( 'css/wpmediacategory.min.css', __FILE__ ), array(), '2.1.2' );
	}
